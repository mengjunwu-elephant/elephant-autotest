...
# 从Excel中提取数据
cases = get_test_data_from_excel(TestMercury.MY_HAND_TEST_DATA_FILE, "get_hand_gripper_id")


@ddt
class TestGetHandGripperID(unittest.TestCase):
    ...
    @data(*cases)
    def test_get_hand_gripper_id(self, case):
        ...
        # 请求发送
        response = self.device.ml.get_hand_gripper_id()
        try:
            # 请求结果类型断言
