...
# 从Excel中提取数据
cases = get_test_data_from_excel(TestProGripper.TEST_DATA_FILE, "pause")
...
class TestPause(unittest.TestCase):
    ...
    def tearDownClass(cls):
        cls.device.m.set_gripper_resume()
        cls.device.m.close()
    ...
    def test_pause(self, case):
        ...
        # 请求发送
        self.device.m.set_gripper_value(100, 100)
        sleep(0.2)
        response = self.device.m.set_gripper_pause()
        try:
            # 请求结果类型断言
