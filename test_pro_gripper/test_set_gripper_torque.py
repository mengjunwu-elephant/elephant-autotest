...
# 从Excel中提取数据
cases = get_test_data_from_excel(TestProGripper.TEST_DATA_FILE, "set_gripper_torque")


@ddt
class TestSetGripperTorque(unittest.TestCase):
    # 实例化日志模块
    logger = logger
    ...
    def tearDownClass(cls):
        cls.device.m.set_gripper_torque(100)
        cls.device.m.close()
    ...
    def test_out_limit(self, case):
        ...
        try:
            with self.assertRaises(ValueError,
                ...
                self.device.m.set_gripper_torque(case["parameter"])
