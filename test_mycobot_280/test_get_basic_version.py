...
from settings import TestMycobot280

# 从Excel中提取数据
cases = get_test_data_from_excel(TestMycobot280.TEST_DATA_FILE, "get_basic_version")


@ddt
class TestGetBasicVersion(unittest.TestCase):
    # 实例化日志模块
    logger = logger
    ...
    def test_get_basic_version(self, case):
        ...
        # 请求发送
        response = self.device.mc.get_basic_version()
