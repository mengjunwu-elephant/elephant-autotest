...
# 从Excel中提取数据
cases = get_test_data_from_excel(TestProGripper.TEST_DATA_FILE, "get_gripper_torque")


@ddt
class TestGetGripperTorque(unittest.TestCase):
    # 实例化日志模块
    logger = logger
    ...
    @data(*cases)
    def test_get_gripper_torque(self, case):
        ...
        # 请求发送
        response = self.device.m.get_gripper_torque()
