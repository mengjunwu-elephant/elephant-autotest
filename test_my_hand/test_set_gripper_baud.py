...
# 从Excel中提取数据
cases = get_test_data_from_excel(TestMyHand.TEST_DATA_FILE, "set_gripper_baud")
...
class TestSetGripperBaud(unittest.TestCase):
    ...
    def tearDownClass(cls):
        cls.device = TestMyHand(baudrate=1000000)
    ...
    def test_set_gripper_baud(self, case):
        ...
        # 重新连接夹爪
        self.device.m.close()
        self.device = TestMyHand(baudrate=baud[case["parameter"]])
        # 验证设置波特率是否设置成功
