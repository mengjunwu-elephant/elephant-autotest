...
# 从Excel中提取数据
cases = get_test_data_from_excel(TestMyHand.TEST_DATA_FILE, "get_gripper_id")


@ddt
class TestGetGripperID(unittest.TestCase):
    # 实例化日志模块
    logger = logger
    ...
    @data(*cases)
    def test_get_gripper_id(self, case):
        ...
        # 请求发送
        response = self.device.m.get_gripper_Id()
