...
# 从Excel中提取数据
cases = get_test_data_from_excel(TestProGripper.TEST_DATA_FILE, "get_gripper_min_pressure")


@ddt
class TestGetGripperMinPressure(unittest.TestCase):
    ...
    @data(*cases)
    def test_get_gripper_min_pressure(self, case):
        ...
        # 请求发送
        response = self.device.m.get_gripper_mini_pressure()
        try:
            # 请求结果类型断言
